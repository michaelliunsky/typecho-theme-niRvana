<div class="global_search_form fullscreen_search visible container" style="padding-top: 60px;">
    <div class="searchbox clearfix">
        <form name="myform" onkeydown="if(event.keyCode==13){so(); return false;}" onsubmit="so(); return false;">
    ...
    <aside data-id="sidebar-1" class="sidebar" style="display: block;">
        <ul class="widget-list">
            <li id="pf_tag_cloud-widget-3" class="widget pf_tag_cloud">
                ...
                <ul class="tag">
                    <?php while ($tags->next()): ?>
                    <li><a href="<?php $tags->permalink(); ?>"
                            target="_self"><?php $tags->name(); ?></a>
                    </li>
                    <?php endwhile; ?>
                    <?php else: ?>
                    <li style="color: #738192">
                        <?php _e('站长没有提供任何关键词'); ?>
                    </li>
                    <?php endif; ?>
                </ul>
...
<script type="text/javascript">
    function so() {
        ...
        var overhref = "<?php $this->options->siteUrl(); ?>search/" + name;

<div class="pagenav" style=""><div class="panda_pagi" pandatab="" active-class=".active" sub-class=".sub-menu"><ul class="menu">
...
<?php if($this->_currentPage>1) echo $this->_currentPage;  else echo 1;?> / <?php echo ceil($this->getTotal() / $this->parameter->pageSize); ?></a></li>

                        ...
                        <div class="page">
                            <div class="container flex-row-middle coverflow">
                                ...
                                <div class="image flex-center">
                                    <div class="card" style="background-image: url(<?php showThumbnail($this); ?>);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="imgColor" style="background:url(<?php showThumbnail($this); ?>) no-repeat;-webkit-filter: blur(50px);-moz-filter: blur(50px);-ms-filter: blur(50px);filter: blur(50px);transform: scale(1.2);background-size:cover;background-position: center;"></div>
            </div>
        </div>
                    ...
                    <div class="col-xs-12">
                        <div class="row postLists">
                            <div class="article_wrapper post clearfix">
                                <div class="meta"><span class="inline-block"><i class="icon font_family icon-clock"></i><?php $this->date('n月j日 · Y年'); ?></span><span class="inline-block"><i class="icon font_family icon-bookmark"></i><?php $this->category(' · ', false); ?></span>
                                </div>
